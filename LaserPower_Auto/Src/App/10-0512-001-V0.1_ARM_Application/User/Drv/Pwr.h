...
#define ADC_TO_VOL(d, a)                                                                                               \
    (PwrDataGet(a, PWR_OUTPUT_VOL) * 0.1 /*V*/ - ((d) * ADC_VREF / 4096 * (th_AdVolPara * 0.001) * 0.001 /*V*/))

#define CUR_TO_DAC(d)  ((d) * 4096 * 2500 /*mV*/ / DAC_VREF / 50 /*A*/)
#define CUR_TO_ADC(d)  ((d) * 4096 * 2500 /*mV*/ / ADC_VREF / 50 /*A*/)


#define CUR_TO_FREQ(d) ((((float)(d) / 50.0) * (5000.0 - 10.0)) + 10.0 + 1.0)

#define PSC_TO_FREQ(d) (Fclk / (((float)(TIM4->ARR) + 1.0) * ((float)(d) + 1.0)))

#define PSC_TO_CUR(d) (((((Fclk / (((float)(TIM4->ARR) + 1.0) * ((float)(d) + 1.0)) + 1.0) - 10.0) * 50.0) / (5000.0 - 10.0)) + 1.0)
