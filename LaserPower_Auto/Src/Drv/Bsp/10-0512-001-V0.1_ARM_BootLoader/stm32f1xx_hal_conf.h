/*
    ...
    Configuration File for STM32 HAL Module
*/
...
/*
    ...
    01b, 11Mar20, Karl Modified ETH_RXBUFNB -> 2, ETH_TXBUFNB -> 2
*/
...
#define ETH_RXBUFNB                    ((uint32_t)2)       /* 2 Rx buffers of size ETH_RX_BUF_SIZE  */
