...
static GpioCtrl_t s_xGpioOut[] = {
   ...
   {MPWR1_EN,        PORT(MPWR1_EN),        PIN(MPWR1_EN),        GPIO_OFF,      GPIO_MODE_OUTPUT_PP,        GPIO_PULLUP,      GPIO_SPEED_FREQ_HIGH,      "MPWR1_EN"        },
...
static GpioCtrl_t s_xGpioIn[] = {
   {MPWR1_STAT_AC,   PORT(MPWR1_STAT_AC),   PIN(MPWR1_STAT_AC),   GPIO_OFF,      GPIO_MODE_INPUT,        GPIO_PULLUP,      GPIO_SPEED_FREQ_HIGH,      "MPWR1_STAT_AC"   },
   {MPWR1_STAT_DC,   PORT(MPWR1_STAT_DC),   PIN(MPWR1_STAT_DC),   GPIO_OFF,      GPIO_MODE_INPUT,        GPIO_PULLUP,      GPIO_SPEED_FREQ_HIGH,      "MPWR1_STAT_DC"   },
...
static GpioCtrl_t s_xGpioIn[] = {
   {MPWR1_STAT_AC,   PORT(MPWR1_STAT_AC),   PIN(MPWR1_STAT_AC),   GPIO_OFF,      GPIO_MODE_INPUT,        GPIO_PULLUP,      GPIO_SPEED_FREQ_HIGH},
   {MPWR1_STAT_DC,   PORT(MPWR1_STAT_DC),   PIN(MPWR1_STAT_DC),   GPIO_OFF,      GPIO_MODE_INPUT,        GPIO_PULLUP,      GPIO_SPEED_FREQ_HIGH},
