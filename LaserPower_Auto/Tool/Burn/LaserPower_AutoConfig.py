...
def ConfigInfo(comPort,pwrType,realTime):
    ...
    if (pwrType == 1):
        ...
        strResp += CliExec(comPort, "cfg_set_max_cur 43.5")
        strResp += CliExec(comPort, "cfg_set_work_cur 40.5")
    ...
    strResp += CliExec(comPort, "enable_manual_ctrl 0")
    
    strResp += CliExec(comPort, "cfg_set_mod_en 0  0")  # MANUAL
